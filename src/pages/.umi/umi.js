...
import findRoute, {
  getUrlQuery,
} from '/Users/wuxiao/github-project/ant-design-pro-nologin/node_modules/_umi-build-dev@1.16.10@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/_umi-plugin-ui@1.4.10@umi-plugin-ui/lib/bubble').default(
      {
        port: 3000,
        path: '/Users/wuxiao/github-project/ant-design-pro-nologin',
        currentProject: '',
        isBigfish: undefined,
      },
    );
